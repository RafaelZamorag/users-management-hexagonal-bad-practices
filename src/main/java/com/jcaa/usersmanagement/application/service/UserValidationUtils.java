 ...
 * Esta clase "Utils" agrupa métodos que en realidad pertenecen a sus
 * respectivos objetos
 ...
 * La lógica de negocio vive en los objetos de negocio, no en utilitarios
 * genéricos.
 ...
 * "contenedor de cosas relacionadas vagamente". Eso es exactamente baja
 * cohesión.
 */
@UtilityClass
public class UserValidationUtils {
  ...
  // merezca):
  // Este método recibe userId, email y status como String y int desnudos en lugar
  // de
  // usar los tipos de dominio UserId, UserEmail y UserStatus.
  // El código pierde toda la protección de invariantes que ofrecen los value
  // objects:
  // un id vacío, un email malformado o un status inválido pasarían
  // desapercibidos.
  // La regla dice: encapsula conceptos como UserId, Email, Status con sus propios
  // tipos.
  // Clean Code - Regla 5 (pocos parámetros): además recibe maxInactivityDays como
  // primitivo int suelto, que podría encapsularse en un objeto de política de
  // acceso.
  public static boolean canPerformAction(
    ...
    // Clean Code - Regla 17: condición larga y difícil de leer que debería
    // extraerse.
