...
public final class UserAlreadyExistsException extends DomainException {
  ...
  private static final String EMAIL_ALREADY_EXISTS_MESSAGE_FORMAT = "A user with email '%s' already exists.";
  ...
  public static UserAlreadyExistsException becauseEmailAlreadyExists(final String email) {
    return new UserAlreadyExistsException(String.format(EMAIL_ALREADY_EXISTS_MESSAGE_FORMAT, email));
  }
}
